...
class ReacherEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release
    ...
    def set_goal_position(self, goal_pos):
        # Access and modify the goal position
        import mujoco
        geom_id = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_GEOM, "goal_pos")
        self.model.geom_pos[geom_id] = [goal_pos[0], goal_pos[1], 0.01]
